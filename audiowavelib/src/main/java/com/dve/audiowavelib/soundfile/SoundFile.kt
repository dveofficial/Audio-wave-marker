 ...
 */
package com.dve.audiowavelib.soundfile
...
public class SoundFile private constructor() {

    private val serialVersionUID = -2505698991597837165L
    private lateinit var mProgressListener: ProgressListener
    ...
    var fileSizeBytes = 0
        private set
    var avgBitrateKbps // Average bit rate in kbps.
            = 0
        private set
    var sampleRate = 0
        private set
    ...
    var numSamples // total number of samples per channel in audio file
            = 0
        private set
